...
int main(int argc, char **argv)
{
    ...
    if (strcmp(APP_CONFIG(app)->battery_info_position, "main-window") != 0) {
        gtk_widget_show_all(GTK_WIDGET(APP_BATTERY_INFO_WINDOW(app)));
        gtk_window_present(APP_BATTERY_INFO_WINDOW(app));
    }
    gtk_main();
